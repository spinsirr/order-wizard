...
| Choice | `Checkbox`, `Select`, `Slider`, `ToggleGroup` |
...
- Guard command: `bun run check:design`
...
- The `src/content` host-page adapter exception is deliberate and may not spread into the side panel, settings, or demo.
